...
> 又是一个经典的 Todo 应用。但我实在是不知道该怎么教 —— Flutter 要是只讲理论，上一讲就讲的差不多了。剩下的就是教你们怎么用组件和一些库了。
...
![](/assets/v2-52e3069196a1d6bdc354f90223c1f9c6_r.jpg)
...
![](/assets/v2-8ac4a07ffc9994e2310d54689eeaaf08_r.jpg)
...
1.  两个按钮，一个是取消按钮，一个是确认按钮。
 
2.  当点击确认按钮时，我们调用`setState`方法，将新的 TodoModel 添加到 todoList 中。
 
3. 然后，我们调用`Navigator.of(context).pop()`方法，关闭弹窗。
