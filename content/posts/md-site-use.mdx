---
title: 这里有个在线Markdown编辑器，要不要试一下
date: '2024-11-18'
summary: 开源项目 md 的使用体验与功能介绍。
tags:
  - 开发
  - 推荐
category: 心情随笔
cover: /notion-covers/md-site-use.png
---
...
![](/notion-images/md-site-use/001-35e34ff2f222.png)
md项目界面
这个是个开源的Markdown转微信公众号文章网站项目，可以实时渲染成相应的微信图文。就比如说现在：
![](/notion-images/md-site-use/002-46b4144e4e9b.png)
md网站 - 页面
...
![](/notion-images/md-site-use/003-8960c772e7bd.png)
基础样式
而上方则有一堆菜单/按钮，现在我们来一一介绍：
![](/notion-images/md-site-use/004-10b9fe144ab8.png)
## 文件 & 格式
左边的文件主要就是用来进行导入导出文件：
![](/notion-images/md-site-use/005-5c7178c758c0.png)
文件菜单
在这里我们可以使用**深色模式**，而如果将左侧编辑的✔给勾掉，就会进行左右互换。
格式则是使用进行一些傻瓜式操作：
![](/notion-images/md-site-use/006-525506c6e4da.png)
格式菜单
我们在这里可以快捷键。而这里的微信外链转底部引用，主要功能就是将一部分的（除微信公众号链接的）超链接转化成引用。
## 编辑
编辑菜单主要有两个功能：**上传图片** 和 **插入表格**
![](/notion-images/md-site-use/007-cf22c3c57e9d.png)
编辑菜单
上传图片这里，主要是将图片传到图床。这里md支持以下图床：
![](/notion-images/md-site-use/008-e7b29a65cb81.png)
支持图床
> 如果你直接复制图片在Markdown编辑器上面，也会让编辑器上传到图床中
## 样式
样式这里功能很多，我这里只讲一个：**自定义CSS**
![](/notion-images/md-site-use/009-a1a0b0255790.png)
样式菜单
当你点击自定义CSS时，就会给你蹦出来一个新的页面：
![](https://camo.githubusercontent.com/89ed91ca09554c0465606b366841867c45700c064d99a1ec1501a4ea0a2a5174/68747470733a2f2f63646e2d646f6f63732e6f73732d636e2d7368656e7a68656e2e616c6979756e63732e636f6d2f67682f646f6f63732f6d642f696d616765732f64656d6f332e676966)
这里用md官方的GIF
...
## 主题（在右边）
点击右边的第一个按钮，就会出来一个菜单：
![](/notion-images/md-site-use/010-9dfbd906658b.png)
菜单
