...
```chart
{
  ...
  "title": "渠道占比",
  "data": [
    { "name": "搜索", "value": 420, "color": "var(--chart-1)" },
    { "name": "社媒", "value": 260, "color": "var(--chart-2)" },
    { "name": "外链", "value": 140, "color": "var(--chart-3)" }
  ]
}
```
...
```chart
{
  ...
  "series": [
    { "key": "frontend", "label": "前端", "color": "var(--chart-line-primary)" },
    { "key": "backend", "label": "后端", "color": "var(--chart-line-secondary)" }
  ],
  "data": [
