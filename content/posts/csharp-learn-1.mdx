---
title: 和iOS Club一起学C#（一）什么是C#
date: '2024-07-31'
summary: 和iOS Club一起学C#（一）什么是C#（Notion 导入）
tags:
  - CSharp
  - 推荐
category: 和iOS Club一起学C#
cover: /notion-covers/csharp-learn-1.jpg
---
...
> 省流版：C#是 微软 开发的 面对对象 ，跨平台，强类型的语言，他的平台是 .NET。
...
1. **Linux和MacOS**：可以使用Visual Studio Code，或者使用 JetBrains Rider。
...
![](https://prod-files-secure.s3.us-west-2.amazonaws.com/08ce0f67-8cac-4bb5-b79a-7a40936baf90/dff3b979-b817-40c7-8907-5198a4db7a29/image.png)
...
1. 下载VS Code：[https://code.visualstudio.com/](https://code.visualstudio.com/)
...
1. 下载Rider：[https://www.jetbrains.com/rider/download/](https://www.jetbrains.com/rider/download/)

1. 下载插件：在插件(Plugins)中搜索 Chinese (Simplified) ，找到安装即可
...
1. 打开Rider，点击新建解决方案：
  ![](image/iOSClub和你一起学CSharp（1）/1722441561073.png)

  1722441561073

1. 选择控制台，然后输入解决方案的名称和项目名称（懒得改就算了）
