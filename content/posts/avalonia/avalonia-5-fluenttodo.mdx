---
title: Avalonia（五）使用其他主题来写一个待办事项软件
date: '2024-01-02'
summary: 使用 FluentAvalonia 主题搭建 Todo 应用。
tags:
  - 开发
  - CSharp
category: 简单的Avalonia
cover: /notion-covers/avalonia-5-fluenttodo.svg
previous: avalonia-4-mvvmpractice-fileviewer
---

# 前言
我们之前都是使用Avalonia自带的主题去写，感觉对于新手来说有点难（因为要好看的话得自己去写大量的风格跟自定义主题）。不过Avalonia的社区也有大量优秀的控件主题库。这次我们使用的是FluentAvalonia。
<unknown url="https://www.notion.so/42c9617decc5487ea2aa8688482b709a#13def69cd9384818acb16d303410d96c" alt="external_object_instance"/>
![](/notion-images/avalonia-5-fluenttodo/001-14b802454f15.png)
...
![](/notion-images/avalonia-5-fluenttodo/002-0eb6670600ba.png)
## 在App.axaml中引用主题
...
```
![](/notion-images/avalonia-5-fluenttodo/003-80a306baf2ee.png)
# 我们尝试写一个Todo应用
...
```
现在可以看看效果：
![](/notion-images/avalonia-5-fluenttodo/004-25909a6a3b0e.png)
![](/notion-images/avalonia-5-fluenttodo/005-ca20581204d0.png)
## 使用Frame面板
...
```
现在基本上已经搞定了，来看一下：
![](/notion-images/avalonia-5-fluenttodo/006-a9ce3f81fc82.png)
![](/notion-images/avalonia-5-fluenttodo/007-53efaf251d6e.png)
# 结尾
现在我们学会了使用主题写应用。
