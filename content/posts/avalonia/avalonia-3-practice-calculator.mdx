---
title: Avalonia（三）普通架构实战——计算器
date: '2023-12-29'
summary: 使用普通架构实现 Avalonia 计算器应用。
tags:
  - 开发
  - CSharp
category: 简单的Avalonia
cover: /notion-covers/avalonia-3-practice-calculator.svg
previous: avalonia-2-initproj
next: avalonia-4-mvvmpractice-fileviewer
---
...
首先我们得知道我们应该要写成什么样子。
一般来说一个计算器的结构是这样的：
![](/notion-images/avalonia-3-practice-calculator/001-043a0440c2ce.jpg)
我们可以按照这个来写。
## 分析一下结构
...
```
![](/notion-images/avalonia-3-practice-calculator/002-341ff177b926.png)
...
```
效果是这样的：
![](/notion-images/avalonia-3-practice-calculator/003-18173e07fbf4.png)
这里没有截完，不过无伤大雅。
简单讲一下这里用到的属性：
...
```
现在的样子就变得好看了点：
![](/notion-images/avalonia-3-practice-calculator/004-713fc35c01ec.png)
