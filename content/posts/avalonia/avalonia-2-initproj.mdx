---
title: Avalonia（二）简单介绍一下项目
date: '2023-12-28'
summary: Avalonia 项目结构与 MVVM 基础说明。
tags:
  - CSharp
  - 开发
category: 简单的Avalonia
cover: /notion-covers/avalonia-2-initproj.svg
previous: avalonia-1-start
next: avalonia-3-practice-calculator
---
...
![](/notion-images/avalonia-2-initproj/001-b9a27644733a.png)
（这里使用Rider进行演示，也建议使用Rider来进行Avalonia开发）
打开项目之后我们可以在Rider左侧的解决方案面板
![](/notion-images/avalonia-2-initproj/002-80f348243a85.png)
...
## MVVM项目
我们先在Rider创建项目：
![](/notion-images/avalonia-2-initproj/003-178a01f11549.png)
现在让我们看一下项目的结构：
![](/notion-images/avalonia-2-initproj/004-88249c131e7b.png)
...
![](/notion-images/avalonia-2-initproj/005-2c7ca06d71bc.png)
...
![](/notion-images/avalonia-2-initproj/006-73307afc76f1.png)
...
我们现在运行一下，看看效果：
![](/notion-images/avalonia-2-initproj/007-5f84c82f14c5.png)
成功了！
## 数据模板跟`ViewLocator` 类
