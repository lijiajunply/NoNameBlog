---
title: Avalonia（四）MVVM架构实战——文件浏览器
date: '2024-01-02'
summary: 基于 MVVM 实现文件浏览器的完整实践。
tags:
  - 开发
  - CSharp
category: 简单的Avalonia
cover: /notion-covers/avalonia-4-mvvmpractice-fileviewer.svg
previous: avalonia-3-practice-calculator
next: avalonia-5-fluenttodo
---
...
```
界面长这个样：
![](/notion-images/avalonia-4-mvvmpractice-fileviewer/001-058295d0351d.png)
...
<tr>
<td>`OneWay`</td>
<td>数据源的更改会自动传播到绑定目标</td>
</tr>
<tr>
<td>`TwoWay`</td>
<td>数据源的更改会自动传播到绑定目标，反之亦然。</td>
</tr>
<tr>
<td>`OneTime`</td>
<td>从数据源传播的值在初始化时传播到绑定目标，但后续更改将被忽略</td>
</tr>
<tr>
<td>`OneWayToSource`</td>
<td>绑定目标的更改会传播到数据源，但反之不会。</td>
</tr>
<tr>
<td>`Default`</td>
<td>绑定模式基于代码中属性的默认模式。见下文。</td>
</tr>
</table>
