...
export function LinkCard({ url, description, title, icon }: LinkCardProps) {
    return (
        <div className={'flex justify-center'}>
            <a href={url} target="_blank" rel="noopener noreferrer" className="no-underline! flex items-center justify-between p-4 dark:bg-gray-800 bg-gray-100 rounded-2xl"
